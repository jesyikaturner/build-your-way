...
public class newPlayerControls : MonoBehaviour {
	...
	newBoardManager boardManager;
	public newPlaceScript selected;

	// Use this for initialization
	void Start () 
	{
		boardManager = transform.GetComponent<newBoardManager>();
	}
	...
	void MouseControls()
	{
		...
		{
			if(hit.collider.gameObject.GetComponent<newPlaceScript>())
			{
				newPlaceScript temp = hit.collider.gameObject.GetComponent<newPlaceScript>();
	...
	void MoveTile(newPlaceScript place)
	{
	...
	void MoveAttacker(newPlaceScript place)
	{
    ...
    void DestroyTile(newPlaceScript place)
    {
